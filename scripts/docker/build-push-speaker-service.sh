...
#
# Build and Push Script for Speaker Service
#
# This script builds the Docker image for the Speaker Service and pushes it
# to the configured container registry.
#
# Usage:
#   ./build-push-speaker-service.sh
#
...
#
# Examples:
#   TAG=v1.0.0 ./build-push-speaker-service.sh
#   SKIP_PUSH=true ./build-push-speaker-service.sh
#   DRY_RUN=true ./build-push-speaker-service.sh
#
