...
#
# Build and Push Script for API Gateway Service
#
# This script builds the Docker image for the API Gateway service and pushes it
# to the configured container registry.
#
# Usage:
#   ./build-push-api-gateway.sh
#
...
#
# Examples:
#   TAG=v1.0.0 ./build-push-api-gateway.sh
#   SKIP_PUSH=true ./build-push-api-gateway.sh
#   DRY_RUN=true ./build-push-api-gateway.sh
#
