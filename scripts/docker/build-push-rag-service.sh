...
#
# Build and Push Script for RAG Service
#
# This script builds the Docker image for the RAG Service (Python/FastAPI + LangChain)
# and pushes it to the configured container registry.
#
# Usage:
#   ./build-push-rag-service.sh
#
...
#
# Examples:
#   TAG=v1.0.0 ./build-push-rag-service.sh
#   SKIP_PUSH=true ./build-push-rag-service.sh
#   DRY_RUN=true ./build-push-rag-service.sh
#
