...
#
# Build and Push Script for Evaluation Service
#
# This script builds the Docker image for the Evaluation Service (Python/FastAPI)
# and pushes it to the configured container registry.
#
# Usage:
#   ./build-push-evaluation-service.sh
#
...
#
# Examples:
#   TAG=v1.0.0 ./build-push-evaluation-service.sh
#   SKIP_PUSH=true ./build-push-evaluation-service.sh
#   DRY_RUN=true ./build-push-evaluation-service.sh
#
...
DOCKERFILE="docker/Dockerfile.evaluation-service"
BUILD_CONTEXT="."
